{combine_script id='jquery.selectize' load='footer' path='themes/Ibufetum/js/plugins/selectize.min.js'}
{combine_css path="admin/themes/default/fontello/css/animation.css" order=10} {* order 10 is required, see issue 1080 *}
{combine_script id='jquery.tipTip' load='header' path='themes/Ibufetum/js/plugins/jquery.tipTip.minified.js'}
{combine_css path="themes/Ibufetum/css/search.css" order=-100}
{combine_css path="themes/Ibufetum/css/{$themeconf.colorscheme}-search.css" order=-100}
...
{combine_script id='mcs' load='async' require='jquery' path='themes/Ibufetum/js/mcs.js'}
